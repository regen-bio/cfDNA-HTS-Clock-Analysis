...
def _prep_heatmap_data(data: dict[str, pylib.dataset.BetaDepth]) -> dict[str]:
	# determine:
	#   beta bin
	#   depth bin
	#   histograms
	...
	# save as pickle
	fname = "beta_vs_depth_hist_2d.pkl"
...
def _main():
	...
	# loading data
	data = {ds: pylib.dataset.BetaDepth.load_dataset(ds) for ds in datasets}
	...
	figure.savefig("fig_s9.svg", dpi=600)
